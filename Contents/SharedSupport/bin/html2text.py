#!/usr/bin/env python
"""html2text: Turn HTML into equivalent Markdown-structured text (specialized version for MailMate)."""
__version__ = "3.200.3"
